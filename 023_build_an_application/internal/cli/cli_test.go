...
func TestCLI(t *testing.T) {
	t.Run("start game with 3 players and finish game with 'Chris' as winner", func(t *testing.T) {
		...
		assertMessagesSentToUser(t, stdout, mod_cli.PlayerPrompt)
	...
	t.Run("it prints an error when a non numeric value is entered and does not start the game", func(t *testing.T) {
		...
		assertMessagesSentToUser(t, stdout, mod_cli.PlayerPrompt, mod_cli.BadPlayerInputErrMsg)
	})
	...
	t.Run("it prints an error when the winner is declared incorrectly", func(t *testing.T) {
		...
		assertMessagesSentToUser(t, stdout, mod_cli.PlayerPrompt, mod_cli.BadWinnerInputMsg)
	})
}
